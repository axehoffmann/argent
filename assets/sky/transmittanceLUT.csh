...
const vec3 rayleighCoeff = vec3(5.47e-6, 1.28e-5, 3.12e-5) * 1e3;
...
void main()
{
	...
	vec3 dir = vec3(sin(zenith), cos(zenith), 0.0);

	vec2 dsts = raySphere(vec3(0.0, Rp + h, 0.0), dir);
	...
	imageStore(lut, ivec2(gl_GlobalInvocationID.xy), vec4(zenith, uv.y, 1.0, 1.0)); 
}
